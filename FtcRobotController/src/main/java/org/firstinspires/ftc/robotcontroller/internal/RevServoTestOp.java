...
@TeleOp(name = "RevServoTestOp", group = "Default")
@Disabled
public class RevServoTestOp extends OpMode {
    //Declare any motors, servos, and sensors
    Servo revServo;

    //Declare any variables & constants pertaining to specific robot mechanisms (i.e. drive train)
    final double REV_MIN = 0.00;
    final double REV_MAX = 1.00;
    double revPosition = (REV_MIN + REV_MAX) / 2.0;

    public RevServoTestOp() {}
